...
class PledgesControllerTest < ActionController::TestCase
  ...
  test "should create pledge" do
    assert_difference('Pledge.count') do
      post :create, pledge: { city: @pledge.city, email: @pledge.email, first_name: @pledge.first_name, last_name: @pledge.last_name, state: @pledge.state, zip: @pledge.zip }
    end
  ...
  test "should update pledge" do
    patch :update, id: @pledge, pledge: { city: @pledge.city, email: @pledge.email, first_name: @pledge.first_name, last_name: @pledge.last_name, state: @pledge.state, zip: @pledge.zip }
    assert_redirected_to pledge_path(assigns(:pledge))
  end
